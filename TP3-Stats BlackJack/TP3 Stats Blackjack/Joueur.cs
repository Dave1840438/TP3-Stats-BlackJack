...
namespace TP3_Stats_Blackjack
{
    public class Joueur
    {
        ...
        public Joueur(UC_Main maMain) { _maMain = maMain; estUneIA = false; AFini = false; }
        public Joueur(UC_Main maMain, NiveauDeRisque niveauDeRisque, bool compteLesCartes) { _maMain = maMain; estUneIA = true; _niveauDeRisque = niveauDeRisque; _compteLesCartes = compteLesCartes; AFini = false; }
